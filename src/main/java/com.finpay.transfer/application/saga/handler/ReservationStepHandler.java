 ...
 *
 * <p>Lab note: the wallet is identified by the source account id — the
 * account→wallet mapping belongs to wallet-service and is a follow-up; this
 * shortcut is documented in the PR.
 */
@Component
