...
/**
 * Domain event published when a transfer saga fails and compensation has
 * completed. Shape matches the v1 contract
 * contracts/events/v1/TransferFailed.json. Written to the outbox atomically
 * with the terminal aggregate state (ADR-0004) and emitted to the
