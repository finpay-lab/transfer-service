...
public final class Transfer {
    ...
    public static Transfer restore(
            ...
            TransferStatus status,
            SagaStep sagaStep) {
        return restore(transferId, customerId, sourceAccountId, destinationAccountId, amount, currency,
     ...
     */
    public boolean matches(UUID customerId, UUID sourceAccountId, UUID destinationAccountId, BigDecimal amount, String currency) {
