 ...
 * aggregate change. An outbox relay (a later task) publishes
 * {@code published_at IS NULL} rows to the {@code finpay.transfer} topic and
 * stamps {@code published_at}; the schema already carries the partial index
 * the relay will use.
 */
@Entity
@Table(
