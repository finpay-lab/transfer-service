...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleValidation(TransferDomainException ex) {
    ...
    public ResponseEntity<ProblemDetail> handleNotFound(TransferNotFoundException ex) {
        return error(HttpStatus.NOT_FOUND, ErrorCode.TRANSFER_NOT_FOUND, ex.getMessage());
    }
